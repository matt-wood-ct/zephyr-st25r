...
#define ST25R3911_REG_WUP_TIMER_CONTROL_mask_wut              (7U<<4)
...
#define ST25R3911_REG_AMPLITUDE_MEASURE_CONF_mask_am_d        (0xfU<<4)
...
#define ST25R3911_REG_PHASE_MEASURE_CONF_mask_pm_d            (0xfU<<4)
